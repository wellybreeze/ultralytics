...
MODELS = ("YOLO", "YOLOWorld", "YOLOE", "NAS", "SAM", "FastSAM", "RTDETR", "RFDETR", "DFINE")
...
if TYPE_CHECKING:
    ...
    from ultralytics.models import YOLO, YOLOWorld, YOLOE, NAS, SAM, FastSAM, RFDETR, RTDETR, DFINE  # noqa
