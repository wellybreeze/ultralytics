...
MODELS = ("YOLO", "YOLOWorld", "YOLOE", "WeDetect", "WeDetectUni", "NAS", "SAM", "FastSAM", "RTDETR")
...
if TYPE_CHECKING:
    ...
    from ultralytics.models import YOLO, YOLOWorld, YOLOE, WeDetect, WeDetectUni, NAS, SAM, FastSAM, RTDETR  # noqa
